...
public class MailService {
	...
	public MimeMessage createMessage(String to) throws MessagingException, UnsupportedEncodingException {
		...
		msgg += "        <h2 style='color: #333333; font-size: 24px; margin: 10px 0 30px 0; font-weight: 500;'>소음일기입니다</h2>";
		...
		msgg += "        <p style='color: #999999; font-size: 14px; margin: 10px 0 0 0;'>© 2025 소음일기. All rights reserved.</p>";
		msgg += "      </td>";
		msgg += "    </tr>";
		msgg += "  </table>";
		msgg += "</body>";
        ...
        message.setFrom(new InternetAddress(senderEmail, "Noise_Diary"));
